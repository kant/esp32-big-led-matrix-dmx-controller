...
// Some Notes:
// The Code works Just fine for smaller Matrixes. (7x7). 
//   For Bigger Matrixes, the Buffer size isnt enought. I try to manage that in another program for bigger Matrixes.
//
//
//
void loop() {
